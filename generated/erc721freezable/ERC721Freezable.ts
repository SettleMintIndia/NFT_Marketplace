...
export class ERC721Freezable extends ethereum.SmartContract {
  static bind(address: Address): ERC721Freezable {
    return new ERC721Freezable("ERC721Freezable", address);
  }
...
export class FreezeAllTokensCall extends ethereum.Call {
  get inputs(): FreezeAllTokensCall__Inputs {
    return new FreezeAllTokensCall__Inputs(this);
  }

  get outputs(): FreezeAllTokensCall__Outputs {
    return new FreezeAllTokensCall__Outputs(this);
  }
}

export class FreezeAllTokensCall__Inputs {
  _call: FreezeAllTokensCall;

  constructor(call: FreezeAllTokensCall) {
    this._call = call;
  }
}

export class FreezeAllTokensCall__Outputs {
  _call: FreezeAllTokensCall;
